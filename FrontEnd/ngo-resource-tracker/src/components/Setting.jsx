...
//                   <p className="text-sm text-gray-500">Receive notifications about low stock items</p>
//                 </div>
//                 <label className="relative inline-flex items-center cursor-pointer">
//                   <input 
//                     type="checkbox" 
...
//                           type="checkbox" 
//                           id={`create-${role.id}`}
//                           checked={role.permissions.includes("all") || role.permissions.includes("create")}
//                           disabled={role.name === "Admin"}
//                           className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
//                         />
//                         <label htmlFor={`create-${role.id}`} className="ml-2 text-sm text-gray-700">
//                           Create Records
//                         </label>
//                       </div>
...
//                           type="checkbox" 
//                           id={`read-${role.id}`}
//                           checked={role.permissions.includes("all") || role.permissions.includes("read")}
//                           disabled={role.name === "Admin"}
//                           className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
//                         />
//                         <label htmlFor={`read-${role.id}`} className="ml-2 text-sm text-gray-700">
//                           View Records
//                         </label>
//                       </div>
...
//                           type="checkbox" 
//                           id={`update-${role.id}`}
//                           checked={role.permissions.includes("all") || role.permissions.includes("write")}
//                           disabled={role.name === "Admin"}
//                           className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
//                         />
//                         <label htmlFor={`update-${role.id}`} className="ml-2 text-sm text-gray-700">
//                           Update Records
//                         </label>
//                       </div>
...
//                           type="checkbox" 
//                           id={`delete-${role.id}`}
//                           checked={role.permissions.includes("all") || role.permissions.includes("delete")}
//                           disabled={role.name === "Admin"}
//                           className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
//                         />
//                         <label htmlFor={`delete-${role.id}`} className="ml-2 text-sm text-gray-700">
//                           Delete Records
//                         </label>
//                       </div>
...
//                           type="checkbox" 
//                           id={`export-${role.id}`}
//                           checked={role.permissions.includes("all") || role.permissions.includes("export")}
//                           disabled={role.name === "Admin"}
//                           className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
//                         />
//                         <label htmlFor={`export-${role.id}`} className="ml-2 text-sm text-gray-700">
//                           Export Data
//                         </label>
//                       </div>
...
//                           type="checkbox" 
//                           id={`admin-${role.id}`}
//                           checked={role.permissions.includes("all") || role.permissions.includes("admin")}
//                           disabled={role.name === "Admin"}
//                           className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
//                         />
//                         <label htmlFor={`admin-${role.id}`} className="ml-2 text-sm text-gray-700">
//                           Admin Access
//                         </label>
//                       </div>
//                     </div>
...
//                     Items with stock below this threshold will trigger low stock alerts
//                   </p>
//                 </div>
//               </div>
...
//                     </div>
//                     <p className="ml-4 text-sm text-gray-500">
//                       Number of days after which users will be required to reset their password (0 to disable)
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//                     <p className="text-sm text-gray-500">Allow users with appropriate permissions to invite new users</p>
//                   </div>
//                   <label className="relative inline-flex items-center cursor-pointer">
//                     <input 
//                       type="checkbox" 
...
//     return (
//       <div className={`fixed bottom-4 right-4 px-4 py-3 rounded-md flex items-center ${
